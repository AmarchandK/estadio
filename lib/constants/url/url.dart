class Config {
  static const String baseUrl = "https://turfoi.herokuapp.com";
  ...
  static const String nearbyGrounds = "/user/nearest-turf/";
  ...
  static const String deleteFav =
      "/user/delete-wishlist/" /*add Turf id in last */;
